...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { body: @sport.body, date: @sport.date, summary: @sport.summary, title: @sport.title }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { body: @sport.body, date: @sport.date, summary: @sport.summary, title: @sport.title }
    assert_redirected_to sport_path(assigns(:sport))
  end
